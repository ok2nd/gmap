...
function showCurrentPosWin(map, latlng) {
	...
	geocoder.geocode({'latLng': latlng}, function(results, status) {
		...
		elevator.getElevationForLocations({
			...
			html += '\');void(0);">→Googleマップ</a>';
			html += '<br><a style="" href="javascript:plotRoute1(\'current\', '+lat+','+lng+', \'w\')">現在地 → 徒歩</a>';
			html += '&nbsp;&nbsp;&nbsp;&nbsp;<a style="" href="javascript:plotRoute1(\'current\', '+lat+','+lng+', \'t\')">→ 車</a>';
			html += '<br><a style="" href="javascript:plotRoute1(\'marker1\', '+lat+','+lng+', \'w\')">青マーカー → 徒歩</a>';
			html += '&nbsp;&nbsp;&nbsp;&nbsp;<a style="" href="javascript:plotRoute1(\'marker1\', '+lat+','+lng+', \'t\')">→ 車</a>';
...
function showMarker(map, position, address, type, opt) {
	...
	elevator.getElevationForLocations({
		...
		html += '\');void(0);">→Googleマップ</a>';
		html += '<br><a style="" href="javascript:plotRoute1(\'current\', '+position.lat()+','+position.lng()+', \'w\')">現在地 → 徒歩</a>';
		html += '&nbsp;&nbsp;&nbsp;&nbsp;<a style="" href="javascript:plotRoute1(\'current\', '+position.lat()+','+position.lng()+', \'t\')">→ 車</a>';
		html += '<br><a style="" href="javascript:plotRoute1(\'marker1\', '+position.lat()+','+position.lng()+', \'w\')">青マーカー → 徒歩</a>';
		html += '&nbsp;&nbsp;&nbsp;&nbsp;<a style="" href="javascript:plotRoute1(\'marker1\', '+position.lat()+','+position.lng()+', \'t\')">→ 車</a>';
		var infowindow = new google.maps.InfoWindow({
...
function createMarker1(lat, lng) {
	...
	var html = '<div class="ttl">';
	html += '<a style="" href="javascript:plotRoute1(\'current\', '+lat+','+lng+', \'w\')">現在地 → 徒歩</a>';
	html += '&nbsp;&nbsp;&nbsp;&nbsp;<a style="" href="javascript:plotRoute1(\'current\', '+lat+','+lng+', \'t\')">→ 車</a>';
...
function plotWalkOff(type) {
	plotRouteClear();
	$('.'+type+'_label').css('display','none');
...
function plotRoute1(mode, lat, lng, type) {
	var waypoints = [];
	var start = null;
	...
	plotRouteViewGo(waypoints, start, end, travelMode, avoidTolls);
	if (type == 't') {
		$(".cb_pt").attr('checked', true);
		$(".cb_pt_label").css("display", "");
	} else {
